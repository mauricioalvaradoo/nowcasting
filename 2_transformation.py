...
df    = pd.read_pickle('Data/monthly/data_2023_12.pkl')
gdp   = pd.read_pickle('Data/quarterly/gdp_2023_12.pkl')
...
# Saving ######################################################################
df_scaled.to_pickle('Data/monthly/data_st_2023_12.pkl')
gdp.to_pickle('Data/quarterly/gdp_st_2023_12.pkl')
